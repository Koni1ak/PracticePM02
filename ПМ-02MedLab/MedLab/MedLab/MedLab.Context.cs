...
namespace MedLab
{
    ...
    {
        private static MedlabEntities _context;
        ...
        public virtual DbSet<Данные_анализатора> Данные_анализатора { get; set; }
        public virtual DbSet<Данные_лаборантов> Данные_лаборантов { get; set; }
        public virtual DbSet<ДанныеСтраховыхКомпаний> ДанныеСтраховыхКомпаний { get; set; }
